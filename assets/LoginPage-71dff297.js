import{d as r,j as e,N as m,a as $,b as k,r as a,c as j,e as v}from"./index-4673e25c.js";import{H as G}from"./HeaderForUnlogged-0dc27499.js";const y=r.button`
    display: flex;
    align-items: center;
...
`,U=()=>{const o=$(),{error:i,isLoading:l}=k(t=>t.auth),[c,f]=a.useState(!1),[s,d]=a.useState({email:"",password:""});a.useEffect(()=>{i&&o(j())},[o]),a.useEffect(()=>{const t=localStorage.getItem("loginFormData")||"";t&&d(n=>({...n,email:t}))},[]);const g=t=>{const{name:n,value:p}=t.target;console.log("a"),n==="email"&&localStorage.setItem("loginFormData",p),d(w=>({...w,[n]:p}))},b=t=>{t.preventDefault(),o(v(s)).catch(n=>{console.error("Помилка входу: ",n)})};return e.jsxs(e.Fragment,{children:[e.jsx(G,{}),e.jsx(C,{children:e.jsxs(F,{children:[e.jsx(L,{children:"Вхід"}),e.jsxs(z,{onSubmit:b,children:[e.jsxs(h,{children:[e.jsx(x,{htmlFor:"email",children:"Email"}),e.jsx(u,{id:"email",name:"email",type:"email",value:s.email,onChange:g,maxLength:40,placeholder:"Введіть email",required:!0})]}),e.jsxs(h,{children:[e.jsx(x,{htmlFor:"password",children:"Пароль"}),e.jsxs("div",{style:{position:"relative"},children:[e.jsx(u,{id:"password",name:"password",type:c?"text":"password",value:s.password,onChange:g,placeholder:"Введіть пароль",required:!0,minLength:6,maxLength:20}),e.jsx(P,{type:"button",onClick:()=>f(t=>!t),children:c?"Сховати":"Показати"})]})]}),e.jsxs(A,{children:[" ",e.jsx(M,{to:"/forgot-password",children:"Забули пароль?"})," "]}),e.jsx(I,{type:"submit",disabled:l,children:l?"Завантаження...":"Увійти"})]}),e.jsx(B,{}),i&&e.jsx(D,{children:i}),e.jsxs(E,{children:["Немає акаунту? ",e.jsx(S,{to:"/register",children:"Зареєструватися"})]})]})})]})};export{U as default};
